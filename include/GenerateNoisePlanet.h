...
public:
    ...
    // calling srand(seed)
    void setupGenerator(int seed);
    double getValue(DRVector3 point);
        
    __inline__ double getSeaLevelInMetres() {return mSeaLevelInMetres;}
    
    __inline__ noise::module::NoiseCache* getOutModul() {return &finalPlanet;}

private:
    
    double mSeaLevelInMetres;
   ...
   // noise::module::Cache finalPlanet;
    ...
    noise::module::NoiseCache finalPlanet;
