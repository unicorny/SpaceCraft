...
void GenerateNoisePlanet::setupGenerator(int seed)
{
	////////////////////////////////////////////////////////////////////////////
	// Constants
	//
	...
	const double MAX_ELEV = 1.0f;// 8192.0;

	// Frequency of the planet's continents.  Higher frequency produces smaller,
	// more numerous continents.  This value is measured in radians.
	const double CONTINENT_FREQUENCY = DRRandom::rDouble(1.5, 0.8);// 1.0;

	// Lacunarity of the planet's continents.  Changing this value produces
	// slightly different continents.  For the best results, this value should
	// be random, but close to 2.0.
	const double CONTINENT_LACUNARITY = DRRandom::rDouble(2.3, 1.8);//2.208984375;

	// Lacunarity of the planet's mountains.  Changing this value produces
	// slightly different mountains.  For the best results, this value should
	// be random, but close to 2.0.
	const double MOUNTAIN_LACUNARITY = DRRandom::rDouble(2.3, 1.8);//2.142578125;
	...
	// close to 2.0.
	const double HILLS_LACUNARITY = DRRandom::rDouble(2.3, 2.8);// 2.162109375;
	...
	// close to 2.0.
	const double PLAINS_LACUNARITY = DRRandom::rDouble(2.3, 2.8);//2.314453125;
	...
	const double SHELF_LEVEL = DRRandom::rDouble(SEA_LEVEL-0.01, SEA_LEVEL-0.45);//-0.375;
	...
	const double MOUNTAINS_AMOUNT = DRRandom::rDouble(0.8, 0.2);// 0.5;
	...
	const double RIVER_DEPTH = DRRandom::rDouble(0.1, 0.01);//0.0234375;

	// Calculate the sea level, in meters. (currently not used)
	...
	badlandsCliffs_cu.ClearAllControlPoints();
	...
	badlandsCliffs_te.ClearAllControlPoints();
	...
	riverPositions_cu0.ClearAllControlPoints();
	...
	riverPositions_cu1.ClearAllControlPoints();
